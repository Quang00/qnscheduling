graph [
    ...
    edge [ source 7 target 8 dist 1.0 ]
    edge [ source 8 target 9 dist 1.0 ]

    edge [ source 10 target 11 dist 1.0 ]
    edge [ source 11 target 12 dist 1.0 ]
    edge [ source 12 target 13 dist 1.0 ]
    edge [ source 13 target 14 dist 1.0 ]

    edge [ source 15 target 16 dist 1.0 ]
    edge [ source 16 target 17 dist 1.0 ]
    edge [ source 17 target 18 dist 1.0 ]
    edge [ source 18 target 19 dist 1.0 ]

    edge [ source 20 target 21 dist 1.0 ]
    edge [ source 21 target 22 dist 1.0 ]
    edge [ source 22 target 23 dist 1.0 ]
    edge [ source 23 target 24 dist 1.0 ]

    edge [ source 0 target 5 dist 1.0 ]
    edge [ source 5 target 10 dist 1.0 ]
    edge [ source 10 target 15 dist 1.0 ]
    edge [ source 15 target 20 dist 1.0 ]

    edge [ source 1 target 6 dist 1.0 ]
    edge [ source 6 target 11 dist 1.0 ]
    edge [ source 11 target 16 dist 1.0 ]
    edge [ source 16 target 21 dist 1.0 ]

    edge [ source 2 target 7 dist 1.0 ]
    edge [ source 7 target 12 dist 1.0 ]
    edge [ source 12 target 17 dist 1.0 ]
    edge [ source 17 target 22 dist 1.0 ]

    edge [ source 3 target 8 dist 1.0 ]
    edge [ source 8 target 13 dist 1.0 ]
    edge [ source 13 target 18 dist 1.0 ]
    edge [ source 18 target 23 dist 1.0 ]

    edge [ source 4 target 9 dist 1.0 ]
    edge [ source 9 target 14 dist 1.0 ]
    edge [ source 14 target 19 dist 1.0 ]
    edge [ source 19 target 24 dist 1.0 ]
]
